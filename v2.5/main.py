...
class SceneDoctorWindow(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._agentic_iter     = 0        # V2.5 agentic loop counter (max 3)
    ...
    def _agentic_check(self):
        """V2.5 — Take a viewport screenshot and send it to the AI for evaluation."""
        try:
            tmp_dir = tempfile.gettempdir()
            path = os.path.join(tmp_dir, "maya_doctor_capture.jpg")
            cmds.playblast(
            ...
            # Add an invisible user message with the screenshot
    ...
    def _send_message(self):
        ...
        self._input.clear()
        self._agentic_iter = 0   # reset loop counter on new user message
